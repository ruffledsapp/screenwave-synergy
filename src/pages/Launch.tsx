...
import ScreenShareLauncher from '@/components/ScreenShareLauncher';
import { 
  ArrowRight, 
  Check, 
  MessageSquare, 
...
const Launch = () => {
  ...
  const [showScreenShareLauncher, setShowScreenShareLauncher] = useState(false);
  ...
  const handleLaunchApp = () => {
    setShowScreenShareLauncher(true);
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Show Screen Share Launcher or Hero Section */}
      {showScreenShareLauncher ? (
        <section className="pt-32 pb-16 px-6 md:px-10 flex items-center justify-center flex-grow">
          <ScreenShareLauncher />
        </section>
      ) : (
        <>
